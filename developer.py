...
class Developer:
    def __init__(self,root):
        ...
        img_top1 = Image.open(r"college_images\Manoj.JPG")
        ...
        # Developer info
        dev_label = Label(main_frame,text="Hello My Name is Manoj",font=("times new roman",20,"bold"),fg="blue",bg="white")
        dev_label.place(x=0,y=5)

        dev_label = Label(main_frame,text="I am a developer",font=("times new roman",20,"bold"),fg="blue",bg="white")
        dev_label.place(x=0,y=40)
        # Add more details here related to me 

        img2 = Image.open(r"college_images\development.JPG")
        img2 = img2.resize((500, 390), Image.Resampling.LANCZOS)
        self.photoimg2 = ImageTk.PhotoImage(img2)

        f_lbl = Label(main_frame, image=self.photoimg2)
        f_lbl.place(x=00, y=210, width=500, height=390)
